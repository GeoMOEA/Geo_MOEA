...
class SC():
    ...
    def kmeans_once(self,loc_set, mid_array):
        ...
        for i in range(len(remain_locs)):
            ...
            for mid in mid_array:
                global_distance.append(self.distance(remain_locs[i], mid))
    ...
    def compute_QLoss(self,release_pro_set):
        ...
        u_list = []
        for k in range(len(self.loc_set)):
            ult_loss = 0
    ...
    def kmeans(self,loc_set,mid_array):
        ...
        while(1):
            ...
            Sparsity_index=self.compute_Sparsity(remain_locs)
            for i in range(len(remain_locs)):
                global_distance1 = []
                for mid in mid_array:
                    global_distance1.append(self.distance(remain_locs[Sparsity_index[i]], mid))
            ...
            for i in range(len(surplus_locs)):
                global_distance2 = []
                for mid in mid_array:
                    global_distance2.append(self.distance(surplus_locs[i], mid))
